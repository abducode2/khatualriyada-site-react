        ...
        <div className="about-wrapper" data-aos="fade-right">
          <div className="about-flex">
            <div className="about-text">
              ...
              <p>
                شركة خط الريادةهي أكثر من مجرد مقاول، نحن شركاء نجاح. ندمج بين
                الخبرة الهندسية العميقة والفهم الدقيق لاحتياجات السوق العقاري،
                لنقدم قيمة حقيقية لعملائنا. رؤيتنا أن نكون رواد التطوير العقاري
                في المنطقة من خلال الالتزام بالجودة والشفافية.
              </p>
